  ...
  <main>
    <PaperDoc>
      ...
      <div class="flex flex-col ml-10">
        <p>
          ข้าพเจ้า
          <FiLL :data="data?.fname" />
          <FiLL :data="data?.lname" /> สมาชิกเลขทะเบียนที่
          <FiLL :data="data?.memberNumber" />
          รับราชการหรือทำงานประจำในตำแหน่ง
          <FiLL :data="data?.location" /> สังกัด
          ...
          <template #data="{ index, item }">
            <p class="text-center">(
              ...
              <FiLL :data="item.m"
                    class="min-w-20" />พ.ศ.
              <FiLL :data="item.y"
                    class="min-w-20" />ต้นเงิน
              <FiLL :data="item.amount"
                    class="min-w-36" />บาท
              พร้อมด้วยดอกเบี้ย
            </p>
          </template>
      ...
      <div class="flex flex-col ml-10">
        ...
        <p class="text-end mr-3">๓.๑ ยินยอมให้ผู้บังคับบัญชา หรือเจ้าหน้าที่ผู้จ่ายเงินได้รายเดือนของข้าพเจ้า
        ...
        <p class="text-end mr-3"> ๓.๒ ยอมให้ถือว่าในกรณีใดๆดังกล่าวในข้อบังคับของสหกรณ์
        ...
        <p class="text-end mr-3"> ๓.๓ ถ้าประสงค์จะขอลาออกหรือย้ายจากราชการ
    ...
    <MorePaperDoc>
      <div class="border-t border-r border-l border-b border-gray-900 p-2">
        ...
        <div class="text-md mt-2">
          ...
          <div class="ml-20">๒.ข้อชี้แจงอื่นๆ
            <FiLL :data="data?.monthlyIncome"
                  date-format="short"
                  class="min-w-28" />
          </div>
        ...
        <p BlankSpace
           class="min-w-50 ml-28 break-all mt-3">
          เจ้าหน้าที่
        ...
        <p class="ml-40 break-all mt-3">
          <FiLL :data="data?.intendent"
                date-format="short"
                BlankSpace
                class="min-w-40" /> ประธาน / รองประธาน /
          ผู้จัดการ / ผู้ที่ได้
          รับมอบหมาย
      ...
      <div class="grid grid-cols-2 justify-center mt-3">
        <div>
          ...
          <div class="flex items-start">
            <div class="border-2 border-black p-2">
              <p class="text-center">บัตรประจำตัว......................................................</p>
              <p class="text-center">เลขที่.....................................................................</p>
            </div>
          </div>
        </div>
      ...
      <div class="mt-3 px-2">
        ...
        <p BlankSpace
           class="min-w-40" /> ข้าพเจ้า
        <FiLL :data="data?.fname"
              class="min-w-32" />
        <FiLL :data="data?.lname"
              class="min-w-32" />ได้รับเงินกู้
        จำนวน
        <FiLL :data="data?.load"
              class="min-w-40" />บาท
      ...
      <div class="grid grid-cols-3 justify-center mt-3">
        ...
        <div class="col-span-2">
          ...
          <p class="mt- text-center ml-1">................................................................ผู้รับเงิน
          </p>
          <p class="text-center">
          <table class="w-60 mx-auto">(<td class="border-black text-center min-w-52"
...
import MorePaperDoc from '~/components/MorePaperDoc.vue';
